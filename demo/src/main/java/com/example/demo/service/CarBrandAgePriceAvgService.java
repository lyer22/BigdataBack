...
@Service
public class CarBrandAgePriceAvgService {

    public HashMap<String, Object> getAgePriceData(String brand, int page, int size) {
        HashMap<String, Object> response = new HashMap<>();
        List<HashMap<String, Object>> data = new ArrayList<>();

        String countQuery = "SELECT COUNT(*) FROM car_brand_age_price_avg WHERE 1=1";
        String query = "SELECT brand, car_age, avg_price FROM car_brand_age_price_avg WHERE 1=1";
